...
The MEM plugin works as a simple interface for entering those dates into custom fields, but it won’t do anything on the public side of your theme. What happens with the dates on the frontend is entirely up to you! You must decide how to display the dates, and you will have to edit your theme files for that…
